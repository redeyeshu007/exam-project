  ...
  return (
    <div style={{ background: 'linear-gradient(135deg,#FAF7F9 0%,#FEF3F8 100%)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 16px' }}>
      <div className="login-card-inner" style={{ background: 'white', borderRadius: '24px', padding: '36px 32px', width: '100%', maxWidth: '420px', boxShadow: '0 20px 60px rgba(27,10,18,0.12)', border: '1px solid #F0ECF0' }}>
        ...
        {/* Logo + Hallocate branding */}
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <img src="/psna1logo.png" alt="PSNA Logo" style={{ height: '56px', objectFit: 'contain', marginBottom: '14px' }} />

          {/* Product name */}
          <h2 style={{ fontFamily: "'Playfair Display',Georgia,serif", fontSize: '32px', fontWeight: '900', color: '#1B0A12', margin: '0 0 4px', lineHeight: 1.1, letterSpacing: '-0.5px' }}>
            Hallocate
          </h2>

          {/* Slogan */}
          <p style={{ color: '#B42B6A', fontSize: '11px', fontWeight: '700', letterSpacing: '0.6px', margin: '0 0 12px' }}>
            E-Exam Hall Allocation
          </p>
          <p style={{ color: '#9B8F94', fontSize: '10.5px', fontWeight: '600', letterSpacing: '0.4px', margin: '0 0 18px' }}>
            PSNA College of Engineering &amp; Technology &nbsp;·&nbsp; Dept. of CSE
          </p>

          {/* Divider */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{ flex: 1, height: '1px', background: 'linear-gradient(to right,transparent,#E8E2E5)' }} />
            <span style={{ color: '#D4CDD0', fontSize: '10px' }}>♦</span>
