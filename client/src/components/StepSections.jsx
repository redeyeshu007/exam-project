      ...
      <div className="d-flex flex-column gap-3 mb-4">
        {sections.map((section) => (
          <div key={section.name} className="section-row">
            ...
            <div className="section-row-controls">
              <div className="section-input-box">
                <input
                  ...
                  required
                />
                <span className="text-muted fw-medium section-students-label">students</span>
              </div>
              <button
                type="button"
                className={`section-delete-btn btn btn-sm rounded-circle d-flex align-items-center justify-content-center ${sections.length <= 1 ? 'btn-light text-muted' : 'btn-outline-danger'}`}
