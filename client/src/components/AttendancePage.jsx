  ...
  return (
    <div className="px-3 px-lg-4 py-4 page-enter">
      ...
      {allocations.length === 0 ? (
        ...
        <>
          {/* Info banner */}
          <div className="attendance-info-banner" style={{
          ...
          {/* ── Desktop Table ── */}
          <div className="d-none d-md-block bg-white rounded-4 border shadow-sm mb-4 attendance-table-wrap">
          ...
          {/* ── Mobile Cards ── */}
          <div className="d-flex d-md-none flex-column gap-3 mb-4 attendance-cards-mobile">
            {allocations.map(alloc => (
              <div key={alloc._id} className="glass-panel bg-white p-4 rounded-4 border shadow-sm attendance-card-mobile">
